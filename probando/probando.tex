...
\def\Authors{
  Mariano Cabanillas-Torpoco\,\textsuperscript{1},
...
Grande,  Rio Grande do Sul,  Brasil
  ...
  \textsuperscript{2} Department X, Institution X,  City X,  State
XX,  Country X
  
  \textsuperscript{3} Department X, Institution X,  City X,  State
XX,  Country X
  }
  ...
  \def\corrAuthor{Co-Author}\def\corrAddress{Laboratorio de Dinamica de
Populações Pesqueiras, Instituto de Oceanografia, Universidade Federal
do Rio Grande\\Av. Itália\\Rio Grande, Rio Grande do
...
\tiny
 \keyFont{ \section{Keywords:} Isurus
paucus, kw2, kw3, kw4, kw5} %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}
